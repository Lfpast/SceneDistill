...
class VFMFeatureLoaderMixin:
    SUPPORTED_VFMS: Tuple[str, ...] = (
        ...
        "qwen3-vl-8b", "qwen3-vl-8b-sensenova", "qwen3-vl-4b", "qwen3-vl-2b", "qwen3.5-4b", "qwen3.5-4b-visual", "spatialstack", "vggt-omega",
    ...
    def _load_vfm_feat(self, vfm_feat_path: str, sel: torch.Tensor):
        ...
        if self.vfm_name in (
            ...
            # Features stored at query_frame positions. VGGT-Omega uses this
            # same layout when extracted with --use-query-frame-indices.
