...
export MODEL_ARGS_BASE="${MODEL_ARGS_BASE:-pretrained=${MODEL_PATH},use_flash_attention_2=true,max_num_frames=32,max_length=12800,scene_distill_stage1_compatibility=${SCENE_DISTILL_STAGE1_COMPATIBILITY},disable_thinking=true}"
