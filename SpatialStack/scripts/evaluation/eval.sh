...
CACHE_ROOT="${CACHE_ROOT:-/project/peilab/jys/spatialstack_store/hf_cache}"
...
# ---------------------------------------------------------------------------
FORCE_OUTPUT_PATH="/project/peilab/jys/qwen3_5_output/eval/only-replace-vggt-with-omega"
